...
class RSA {
	...
	/**
	 * sign data
	 * @param  string $data sign object
	 * @return string $signature Sign string
	 */
	public function sign($data) {
		if (!is_string($data)) {
			throw new Exception("Unable to sign non-string data type.");
		}
	...
	public function verify($data, $sign) {
		if (!is_string($data)) {
			throw new Exception("Unable to verify non-string data type.");
		}
		...
		$result = (bool) openssl_verify($data, $sign, $publicKey);
		openssl_free_key($publicKey);
